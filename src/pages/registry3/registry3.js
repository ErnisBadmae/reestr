...
import { entriesTableColumns3 } from '../../helpers/entriesTableConstants';
...
export const Registry3 = () => {
  ...
  const relocateToCard = (record) => {
    return {
      onClick: (e) => {
        e.preventDefault();
        navigate('/spisok3/' + record.id_sds);
      },
    };
  };
    ...
    <div>
      <Content style={{ padding: '0 20px' }}>
        <div className="registry-sro__filter-wrapper">
          ...
          <div className="registry-sro__name-registry">РЕЕСТР ЭКСПЕРТОВ</div>
          <FilterFilled
