...
import { entriesTableColumns2 } from '../../helpers/entriesTableConstants';
...
export const Registry2 = () => {
  ...
  const relocateToCard = (record) => {
    return {
      onClick: (e) => {
        e.preventDefault();
        navigate('/spisok2/' + record.id_sds);
      },
    };
  };
    ...
    <div>
      <Content style={{ padding: '0 20px' }}>
        <div className="registry-sro__filter-wrapper">
          ...
          <div className="registry-sro__name-registry">РЕЕСТР ОС</div>
          <FilterFilled
